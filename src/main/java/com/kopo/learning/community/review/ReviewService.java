...
public class ReviewService {
    ...
    public List<Post> getReviewList(int page, int size) {
        int offset = (page - 1) * size;
        return postMapper.selectReviewListWithReplyCount(size, offset);
    }
    ...
    public int countReviewPosts() {
        return postMapper.countReviewPosts();
    }
} 