...
public class QnaService {
    ...
    public List<Post> getQnaList(int page, int size) {
        int offset = (page - 1) * size;
        return postMapper.selectQnaListWithReplyCount(size, offset);
    }
    ...
    public int countQnaPosts() {
        return postMapper.countQnaPosts();
    }
} 